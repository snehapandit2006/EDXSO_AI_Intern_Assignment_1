...
class Creator(Base):
    ...
    sub_niche = Column(String(100), default="AI / Developer Tools")
    content_themes = Column(Text, default="[]")  # JSON List
    content_style = Column(String(100), default="Educational & Technical")
    bio = Column(Text, default="")
    recent_content = Column(Text, default="[]")  # JSON List
    contact_email = Column(String(255), default="Not Found")
    email_source = Column(String(100), default="Public Bio")
    ...
    extraction_method = Column(String(100), default="Directory Extraction")
